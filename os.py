...
def get_font(font_path, size):
    ...
    if key not in font_cache:
        try:
            ...
            print(f"Font file '{
                  font_path}' not found, using default system font for size {size}.")
    ...
    if filename not in background_cache:
        try:
            ...
            print(f"Background image '{
                  filename}' not found, using default color.")
...
class PuskButton:
    def __init__(self, x, y, image_path):
        ...
        try:
            ...
            print(f"Error loading pusk button image: {
                  self.image_path}, error: {e}")
    ...
    def __init__(self, window, image_path):
        ...
        if self.image_path:
            try:
                ...
                print(f"Error loading taskbar icon image: {
                      self.image_path}, error: {e}")
                self.image = None
